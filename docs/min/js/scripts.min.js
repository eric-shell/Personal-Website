...
(o=>{o(".work__footer").on("click",".button",function(){o(".work__items").removeClass("work__items--preview"),o(".work__footer").css("display","none")})})(jQuery);
